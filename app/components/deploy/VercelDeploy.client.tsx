...
export function useVercelDeploy() {
  ...
  const handleVercelDeploy = async () => {
    /*
     * A token in the browser is optional: when bolt's server has VERCEL_TOKEN configured,
     * the deploy route signs the request itself. Only bail out when neither side can.
     */
