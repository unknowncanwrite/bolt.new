...
export const PROVIDER_COMPLETION_LIMITS: Record<string, number> = {
  ...
  AmazonBedrock: 8192,
  Hyperbolic: 8192,
  DashScope: 16384, // Qwen chat/coder models accept up to 64k-128k output; conservative default
  Xkiro: 16384, // multi-vendor gateway, per-model limits come from GET /models
};
