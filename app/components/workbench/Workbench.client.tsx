...
import { bootstrapVercelConnection } from '~/lib/stores/vercel';
import { useVercelAutoDeploy } from '~/components/deploy/useVercelAutoDeploy';
...
export const Workbench = memo(
  ({
    ...
    // Ship the app to Vercel by itself once generation is done.
    useVercelAutoDeploy();
    ...
    useEffect(() => {
      if (hasPreview) {
        ...
        /*
         * A generated app is ready to ship: connect Vercel from the configured token so the
         * "Deploy to Vercel" action in the header unlocks without opening Settings first.
         */
